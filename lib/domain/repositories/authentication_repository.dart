...
abstract class AuthenticationRepository {
  Future<Either<Failure,String>> createAccount({required String? address,required String? email,required firstName,required lastName,required password,required String? phone,required String image,required String? oauth,required String? birthDate, required String? gender});
